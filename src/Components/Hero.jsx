...
const Hero = () => {
  function Tab({ title, active, onClick, className }) {
    ...
    return (
      <li
        onClick={onClick}
        className={`cursor-pointer text-center max-[497px]:text-xs px-3 py-2 rounded-md text-sm font-semibold ${activeClasses} ${className}`}
      >
        {title}
      </li>
    );
  ...
  function Slider({ activeTab, numTabs, onClick }) {
    ...
    return (
      <div className="relative mt-1">
        ...
        ></div>
        <ul className="flex max-[497px]:justify-evenly gap-4 mx-auto w-fit after:absolute after:block after:content-[''] after:w-full after:h-[1px] after:left-0 after:bottom-0 after:bg-gray-300 ">
      ...
      <header className="w-full flex justify-center items-center flex-col">
        <nav className=" w-full !flex flex-row justify-between items-center mb-10 pt-3">
          ...
          {/* <div className="flex gap-4 font-medium">
            ...
            <a
              href="https://substack.com/profile/96200052-kobimanuel"
              target="blank"
            >
              Blog
            </a>
